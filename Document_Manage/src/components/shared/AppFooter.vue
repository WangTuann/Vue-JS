		...
		return {
			socials: [
				...
				},
				{
					...
					name: 'Instagram',
					icon: 'instagram',
					url: 'https://instagram.com/quang.ngx',
				},
			],
		};
	},
			...
			>
				...
				<ul class="flex gap-4 sm:gap-8">
					<a
						...
						:href="social.url"
						target="__blank"
						class="text-gray-400 hover:text-red-200 dark:hover:text-red-300 cursor-pointer rounded-lg bg-gray-50 dark:bg-ternary-dark hover:bg-gray-100 shadow-sm p-4 duration-500"
					>
						<i
