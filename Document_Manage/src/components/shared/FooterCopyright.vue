...
<template>
	<div class="flex justify-center items-center text-center">
		...
		>
			&copy; {{ copyrightDate }}.
			<a
				href="https://github.com/quangngx"
				target="__blank"
				class="font-general-medium hover:underline hover:text-rose-600 dark:hover:text-indigo-300 duration-500"
			>
				{{ projectName }}
			</a>
			. Developed by
